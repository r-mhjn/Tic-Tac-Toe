...
import { View, Text, StyleSheet, Dimensions, BackHandler, TouchableOpacity, Alert} from 'react-native';
  ...
  playSound = async () => {
    ...
    return (
      ...
      <View style={styles.titlecontainer}>
        ...
        title="Play Game"
        onPress={ () =>{
            { this.playSound(), this.props.navigation.navigate("PlayerNameScreenSingle") }
        }}          
        >
        <Text
        numberOfLines={1}
        adjustsFontSizeToFit={true}
        style={styles.buttontext}>Single Player</Text>
        </TouchableOpacity>
        ...
        title="Play Game"
        onPress={ () =>{
          {  this.playSound(), this.props.navigation.navigate("PlayerNameScreen");}
        }}          
        >
        <Text
        numberOfLines={1}
        adjustsFontSizeToFit={true}
        style={styles.buttontext}>Multi Player</Text>
        </TouchableOpacity>
        ...
        numberOfLines={1}
        adjustsFontSizeToFit={true}
        style={styles.buttontext}>Quit</Text>
        </TouchableOpacity>
        </View>     
      </View>
    );
