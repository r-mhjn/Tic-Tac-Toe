    ...
    render(){
      return (
        ...
        <Text style={styles.winMessage}>{ this.state.winMessage }</Text>
         ...
         ></Entypo>
         <Text style={styles.scoretext} >{this.state.playerOne}: {this.state.scorePlayerOne}</Text>
         ...
         <Entypo name="cross"
          ...
          style={styles.scoreIcon}
         ></Entypo> 
         <Text style={styles.scoretext} >{this.state.playerTwo}: {this.state.scorePlayerTwo}</Text>
         </View>       
      </View>
